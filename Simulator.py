    ...
    def run(self):
        ...
        while disassembler2.opcodeStr[i] != 'BREAK':
            if disassembler2.opcodeStr[i] == "ADDI":
                ...
                outputFile.write("====================" + "\n" + "cycle:" + str(i+1) + "\t" + str(disassembler2.mem[i])
                ...
                if disassembler2.arg1[i] != disassembler2.arg2[i]:
                    r_32[disassembler2.arg3[i]] = 0
                else:
                    r_32[disassembler2.arg3[i]] = 1
                outputFile.write("====================" + "\n" + "cycle " + str(i + 1) + "\t" + str(Memory)
                ...
                if r_32[disassembler2.arg2[i]] or r_32[disassembler2.arg1[i]] != 0:
                ...
                if r_32[disassembler2.arg2[i]] and r_32[disassembler2.arg1[i]] != 0:
                    r_32[disassembler2.arg3[i]] = r_32[disassembler2.arg2[i]] + r_32[disassembler2.arg1[i]]
                else:
                    r_32[disassembler2.arg3[i]] = 0
                outputFile.write("====================" + "\n" + "cycle " + str(i + 1) + "\t" + str(Memory)
