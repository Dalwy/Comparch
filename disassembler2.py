        ...
        with open(output_file, 'w') as o:
            ...
            for index in range(len(instructions)):
                ...
                if int(opcode[index]) == 1112:
                    ...
                    arg1.append((int(instructions[index], base=2) & rnMask) >> 5)
                    arg2.append((int(instructions[index], base=2) & imMask) >> 10)
                    arg3.append(imm_twos_converter(int(instructions[index], base=2) & rdMask) >> 0)
                    argStr1.append("\tR" + str(arg3[index]))
                    argStr2.append("R" + str(arg1[index]))
                ...
                elif int(opcode[index]) >= 1672 and opcode[index] <= 1673:
                    ...
                    opcodeStr.append("B")
                    arg1.append(imm_twos_converter(int(instructions[index], base=2) & rnMask) >> 5)
                    arg2.append((int(instructions[index], base=2) & imMask) >> 10)
                    arg3.append((int(instructions[index], base=2) & 0x3F) >> 0)
